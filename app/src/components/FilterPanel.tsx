    ...
    <div className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 border border-amber-500/30 rounded-xl p-6 backdrop-blur-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="space-y-2">
          <Label className="text-slate-200 text-sm">搜索</Label>
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 bg-slate-800/80 border-slate-600 text-slate-100 placeholder:text-slate-400 focus:border-amber-500 focus:ring-amber-500/20"
            />
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger className="bg-slate-800/80 border-slate-600 text-slate-100 focus:ring-amber-500/20">
              <SelectValue placeholder="全部种族" />
            </SelectTrigger>
            <SelectContent className="bg-slate-800 border-slate-600">
              <SelectItem value="all" className="text-slate-100 focus:bg-slate-700 focus:text-amber-200">全部种族</SelectItem>
              <SelectItem value="void" className="text-slate-100 focus:bg-slate-700 focus:text-amber-200">虚空</SelectItem>
              <SelectItem value="deathborn" className="text-slate-100 focus:bg-slate-700 focus:text-amber-200">死诞</SelectItem>
              <SelectItem value="ancient_dragon" className="text-slate-100 focus:bg-slate-700 focus:text-amber-200">古龙</SelectItem>
              <SelectItem value="normal_dragon" className="text-slate-100 focus:bg-slate-700 focus:text-amber-200">普通龙</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Input
              ...
              className="bg-slate-800/80 border-slate-600 text-slate-100 placeholder:text-slate-400 focus:border-amber-500 focus:ring-amber-500/20"
            />
